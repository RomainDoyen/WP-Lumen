...
register_activation_hook(__FILE__, static function (): void {
	require_once LUMEN_WP_PATH . 'includes/Job_Repository.php';
	require_once LUMEN_WP_PATH . 'includes/Installer.php';
	\LumenWp\Installer::install();
});
