 ...
 * Description:       Optimise les images de la médiathèque (WebP/AVIF/JPEG) et génère un pack SEO (alts, JSON-LD, Gutenberg). Multi-IA Vision + traitement en arrière-plan.
 * Version:           1.3.12
...
define('LUMEN_WP_VERSION', '1.3.12');
